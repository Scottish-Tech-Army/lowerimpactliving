                    ...
                    <form method="post" action="/api/auth/callback/credentials" className="flex ...">
                        <div className="flex flex-wrap">
                            ...
                            <div className="basis-full pt-3 justify-center">
                                <Link className="flex justify-center w-full link-primary" href="/about">Don't have an account?</Link>
                            </div>
                            <div className="basis-full justify-center">
                                <Link className="flex justify-center w-full link-primary" href="/about">Forgot password?</Link>
                            </div>
                        </div>
                    </form>
                </div>
                <div className="bg-cover bg-no-repeat bg-cente min-w-100 p-9 w-96 content-card" style={{ "background": "url('../images/available-3.jpg')", "marginLeft": "-80px", "height": "460px", "width": "460px" }}></div>
            </div>
